...
namespace SRDebugger.UI.Tabs
{
    ...
    public class ConsoleTabController : SRMonoBehaviourEx
    {
        ...
        [RequiredField] public Toggle FilterToggle;
        [RequiredField] public InputField FilterField;
        [RequiredField] public GameObject FilterBarContainer;
        ...
        private void PopulateStackTraceArea(ConsoleEntry entry)
        {
            ...
            else
            {
                ...
                GameMain.NativeBridge.Copy(text);
            }
