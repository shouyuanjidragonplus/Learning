...
namespace UGF.EditorTools
{
    ...
    public class GameDataGenerator
    {
        ...
        public static void GenerateGroupEnumScript()
        {
            ...
            {
                var excelFileName = AssetsPath.GetCombinePath(excelDir, excel);
        ...
        public static void GenerateUIViewScript()
        {
            ...
            var excelFileName = AssetsPath.GetCombinePath(excelDir, ConstEditor.UITableExcel);
            if (!File.Exists(excelFileName))
            {
        ...
        public static bool ExportLanguageExcel(string excelFile, string outJsonFile, bool useBytes)
        {
            ...
            try
            {
                ...
                File.WriteAllText(outJsonFile, JsonEx.ToJson(languageDic), Encoding.UTF8);
                if (useBytes)
                {
        ...
        public static bool Excel2TxtFile(string excelFileName, string outTxtFile)
        {
            ...
            string tmpExcelFile = AssetsPath.GetCombinePath(fileInfo.Directory.FullName, Utility.Text.Format("{0}.temp", fileInfo.Name));
        ...
        public static void RefreshAllLanguage(IList<string> files = null)
        {
            ...
            for (int i = 0; i < totalExcelCount; i++)
            {
                ...
                {
                    Debug.Log($"Language导出成功:{outputFileName}");
                }
            }
        ...
        public static void RefreshAllDataTable(IList<string> fullPathFiles = null)
        {
            ...
            for (int i = 0; i < dataTbCount; i++)
            {
                ...
                string tbTxtFile = AssetsPath.GetCombinePath(outputDir, dataTableName + outputExtension);
        ...
        internal static string GetGameDataRelativeName(string fileName, string relativePath)
        {
            ...
            return AssetsPath.GetCombinePath(Path.GetDirectoryName(path), Path.GetFileNameWithoutExtension(path));
        }
        ...
        public static string GetGameDataExcelRelativePath(GameDataType tp, string excelFile)
        {
            ...
            excelRelativePath = AssetsPath.GetCombinePath(Path.GetDirectoryName(excelRelativePath), Path.GetFileNameWithoutExtension(excelRelativePath)); // 获取表的相对路径并去掉扩展名
        ...
        public static string GameDataExcelRelative2FullPath(GameDataType tp, string relativeExcelPath)
        {
            ...
            return AssetsPath.GetCombinePath(excelDir, relativeExcelPath + ".xlsx");
        }
        ...
        public static string GetGameDataExcelOutputFile(GameDataType tp, string excelFile)
        {
            ...
            return AssetsPath.GetCombinePath(GetGameDataExcelOutputDir(tp), excelRelativePath + extensionName);
        }
        ...
        private static IList<string> GetFiles(string path, string searchPattern, SearchOption option, string mainExcelName)
        {
            ...
            {
                var abTestPrefixName = mainExcelName + SettingConst.AB_TEST_TAG;
        ...
        public static bool IsABTestFile(string excelFile)
        {
            ...
            return Regex.IsMatch(fileName, Utility.Text.Format("{0}\\p{{L}}$", SettingConst.AB_TEST_TAG));
        }
        ...
        public static bool IsABTestFile(string excelFile, string mainExcelFile)
        {
            ...
            return abFileName.StartsWith(mainFileName + SettingConst.AB_TEST_TAG);
        }
    }
}
#endif