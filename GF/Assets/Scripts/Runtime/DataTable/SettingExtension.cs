...
public static class SettingExtension
{
    ...
    {
        com.SetString(Constant.Setting.ABTestGroup, groupName);
    }
    /// <summary>
    /// 获取A/B测试组
    /// </summary>
    ...
    {
        return com.GetString(Constant.Setting.ABTestGroup, string.Empty);
    }
    /// <summary>
    /// 设置语言
    /// </summary>
    ...
    {
        GF.Localization.Language = lan;
        com.SetString(Constant.Setting.Language, lan.ToString());
    }
    ...
    {
        string lan = com.GetString(Constant.Setting.Language, string.Empty);
