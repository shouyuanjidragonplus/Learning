...
namespace RedDot
{
    ...
    public class RedDotSystem
    {
        ...
        private void InitRedDotTreeNode()
        {
            ...
            foreach (string path in RedDotDefine.lstRedDotTreeList)
            {
                string[] treeNodeAy = path.Split(RedDotDefine.split);
        ...
        {
            var nodeList = strNode.Split(RedDotDefine.split);
        ...
        {
            string[] nodeList = nodePath.Split(RedDotDefine.split);
