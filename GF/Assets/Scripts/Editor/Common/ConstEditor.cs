...
public class ConstEditor
{
    ...
    /// 数据表Excel目录
    /// </summary>
    public static string DataTableExcelPath => AssetsPath.GetCombinePath(Directory.GetParent(Application.dataPath).FullName, "AAAGameData/DataTables");

    /// <summary>
    /// 配置表Excel目录
    /// </summary>
    public static string ConfigExcelPath => AssetsPath.GetCombinePath(Directory.GetParent(Application.dataPath).FullName, "AAAGameData/Configs");
    ...
    public const string DataTableCodePath = "Assets/Export/Scripts/DataTable";
