...
namespace IFix.Editor
{
    ...
    public class IFixEditor
    {
        ...
        public static string GetScriptAssembliesFolder()
        {
            ...
            var assembliesFolder = "Temp/StagingArea/Data/Managed";
            ...
            return  assembliesFolder = "ScriptAssemblies";
#endif
        }
    ...
    public class IFixBuildProcess : IPostBuildPlayerScriptDLLs
    {
        public int callbackOrder { get; }
        public void OnPostBuildPlayerScriptDLLs(BuildReport report)
        {
            IFixEditor.AutoInjectAssemblys();
        }
    }
}
